import pytest
from kafka_producer.main import process_station_status

def test_process_station_status():
    ...
    assert process_station_status(station_status_object) == station_status_records
